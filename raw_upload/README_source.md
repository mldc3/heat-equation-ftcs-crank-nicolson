...
```bash
git clone https://github.com/mldc3/heat-equation-ftcs-crank-nicolson.git
cd heat-equation-ftcs-crank-nicolson
```
...
```bash
python src/heat_equation_ftcs_crank_nicolson.py
```
...
This project demonstrates finite-difference discretization, explicit FTCS time integration, Crank-Nicolson time integration, sparse matrix construction, linear system solving, stability analysis for parabolic PDEs, conservative discretization for variable diffusion, numerical error analysis, runtime benchmarking, scientific Python programming, interpretation of computational physics results and professional research-code documentation.
